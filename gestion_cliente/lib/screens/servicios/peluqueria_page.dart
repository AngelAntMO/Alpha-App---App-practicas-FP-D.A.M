// ============================================================
// PELUQUERIA PAGE - SISTEMA DE RESERVAS MEJORADO
// ============================================================
//
...
const _kMaxReservasPeluqueria = 5;
const _kMaxPorClaseHora = 2;
...
class _PeluqueriaPageState extends State<PeluqueriaPage> {
  ...
  final List<String> horariosTotales = ['09:00', '10:00', '11:00', '12:00', '13:00', '16:00', '17:00', '18:00', '19:00'];
  ...
  Future<void> _reservar() async {
    ...
    try {
      ...
      if (userReservas.docs.length >= _kMaxReservasPeluqueria) {

        _mostrarMensaje(
          'Ya tienes 5 reservas activas en Peluquería',
        );
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        decoration: const BoxDecoration(
          gradient: LinearGradient(
            colors: [Color (0xFFFEFBDD), Color(0xFFE1D3BB), Color(0xFFD7A894) ],
