...
class _FS {
  ...
  // CLASES
  static Stream<QuerySnapshot> clasesPorNegocio(String negocioID) => _db
      .collection('clases')
      .where('negocioID', isEqualTo: negocioID)
      .snapshots();
  static Future<void> crearClase(Clase c) =>
      _db.collection('clases').add(c.toMap());
  ...
  static Stream<QuerySnapshot> workersStream() => _db
      .collection('users')
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    Icon(
                      _iconoNegocio(_negocioSel),
                      color: _colorNegocio(_negocioSel),
                      size: 22,
                    ),
                    const SizedBox(width: 10),
                    Text(
                      'Nueva clase · $_negocioSel',
                      style: const TextStyle(
                        color: Colors.white,
                        fontSize: 16,
                        fontWeight: FontWeight.w600,
                  ...
                  child: Row(
                    children: [
                      CircleAvatar(
                        ...
                        child: Text(
                          w.nombre.isNotEmpty ? w.nombre[0].toUpperCase() : '?',
                          style: TextStyle(
                            color: color,
                            fontSize: 12,
          ...
          child: Column(
            ...
            children: [
              ...
              TextFormField(
                ...
                decoration: _inputDeco(Icons.lock, const Color(0xFF64B5F6)),
              ),
              _fieldModal(
                'Teléfono',
                telCtrl,
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapClases) {
        ...
        final employeeIds =
            snapClases.data?.docs
                .map(
                  (d) =>
                      (d.data() as Map<String, dynamic>)['employeeID']
                          as String? ??
                      '',
                )
        ...
        var workers = employeeIds.isEmpty
            ? allWorkers
            : allWorkers.where((w) => employeeIds.contains(w.id)).toList();
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 2),
                          Text(
                            w.telefono.isNotEmpty ? w.telefono : 'Sin teléfono',
                            style: const TextStyle(
                              color: Colors.white60,
                              fontSize: 11,
                            ),
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 14),
          Text(
            'Clases asignadas en ${widget.negocioSel}',
            style: const TextStyle(
              color: Colors.white60,
              fontSize: 11,
              fontWeight: FontWeight.w500,
...
class _UsuariosTabState extends State<_UsuariosTab> {
  ...
  final Set<String> _filtroNegocios = {};
                              ...
                              child: ElevatedButton(
                                onPressed: cargando
                                    ...
                                    : () async {
                                        ...
                                        set(() => cargando = true);
                                        bool exito =
                                            false; // 1. Añadimos una bandera para saber si fue bien

                                        try {
                                          final appName =
                                              'secondary_${DateTime.now().millisecondsSinceEpoch}';
                                          final secondaryApp =
                                          ...
                                          exito =
                                              true; // 2. Marcamos como exitoso si llegó hasta aquí sin excepciones
                                        } on FirebaseAuthException catch (e) {
                                          ...
                                          if (e.code ==
                                            ...
                                            msg = 'El email ya está en uso';
                                              ...
                                              'weak-password') {
                                            msg =
                                                'Contraseña demasiado débil (mín. 6 caracteres)';
                                          } else if (e.code ==
                                              'invalid-email') {
                                            msg = 'Email no válido';
                                          }
                  ...
                  ? Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 10),
                          Text(
                            'Filtrar por negocios adicionales:',
                            style: const TextStyle(
                              color: Colors.white60,
                              fontSize: 11,
                              fontWeight: FontWeight.w500,
              ...
              child: StreamBuilder<QuerySnapshot>(
                ...
                builder: (context, snap) {
                  ...
                  if (_filtroNegocios.isNotEmpty) {
                    usuarios = usuarios
                        .where(
                          (u) => _filtroNegocios.every(
                            (n) => u.negocios.contains(n),
                          ),
                        )
                        .toList();
                  }
                    ...
                    return Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 12),
                          Text(
                            _busqueda.isNotEmpty || _filtroNegocios.isNotEmpty
                                ? 'Sin resultados'
                    ...
                    children: [
                      Icon(
                        asignado
                            ? Icons.check_circle
                            : Icons.radio_button_unchecked,
                        color: asignado ? c : Colors.white38,
                        size: 18,
                      ),
                      const SizedBox(width: 8),
                      Icon(
          ...
          child: StreamBuilder<QuerySnapshot>(
            ...
            builder: (context, snap) {
              ...
              if (_negocioFiltro != null) {
                reservas = reservas
                    .where((r) => r.negocioNombre == _negocioFiltro)
                    .toList();
              }
              ...
              if (_estadoFiltro != null) {
                reservas = reservas
                    .where((r) => _estadoCoincide(r.estado, _estadoFiltro))
                    .toList();
              }
                ...
                reservas = reservas
                    .where(
                      (r) =>
                          ...
                          r.negocioNombre.toLowerCase().contains(q),
                    )
                    .toList();
              }
